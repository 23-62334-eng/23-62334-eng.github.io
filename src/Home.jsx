...
function Home() {
	...
	return (
		<div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-100 via-white to-gray-400 px-4 sm:px-6">
			<style>{`
				.typing-cursor {
			...
			<div className="max-w-6xl w-full grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-center">
				...
				<div>
					<div className="flex items-center gap-3 mb-4 flex-wrap">
						{/* Name */}
						<span className="px-4 py-1 text-xl sm:text-2xl font-bold rounded-full bg-gray-200 text-gray-700">
							Mark Jordan Javier
						</span>
					...
					<div className="mt-6 flex items-center gap-5 text-2xl sm:text-3xl">
						...
						<a
							href="https://www.linkedin.com/in/mark-jordan-javier-29b72935a2"
							target="_blank"
